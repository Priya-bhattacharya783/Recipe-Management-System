...
router.post('/', async (req, res) => {
    ...
    try {
        ...
        // The response from generateContent will have a candidate with a content.parts[0].text
        // which will be the JSON string if the schema was followed.
